...
BOOL CDlgMenu02::Do2PtAlign0(int nPos, BOOL bDraw)
{
	...
	if (nPos == 1)
	{
		...
		double dRefAlignX0 = pDoc->m_mgrReelmap.m_Master[0].m_stAlignMk.X0 + pView->m_pMotion->m_dPinPosX[0]; // PCB좌표
		double dRefAlignY0 = pDoc->m_mgrReelmap.m_Master[0].m_stAlignMk.Y0 + pView->m_pMotion->m_dPinPosY[0]; // PCB좌표
		double dRefAlignX1 = pDoc->m_mgrReelmap.m_Master[0].m_stAlignMk.X1 + pView->m_pMotion->m_dPinPosX[0]; // PCB좌표
		double dRefAlignY1 = pDoc->m_mgrReelmap.m_Master[0].m_stAlignMk.Y1 + pView->m_pMotion->m_dPinPosY[0]; // PCB좌표
...
BOOL CDlgMenu02::Do2PtAlign1(int nPos, BOOL bDraw)
{
	...
	if (nPos == 1)
	{
		...
		// Cam의 원점 기준의 Marking 이미지 좌표.
		double dRefAlignX0 = pDoc->m_mgrReelmap.m_Master[0].m_stAlignMk.X0 + pView->m_pMotion->m_dPinPosX[1]; // PCB좌표
		double dRefAlignY0 = pDoc->m_mgrReelmap.m_Master[0].m_stAlignMk.Y0 + pView->m_pMotion->m_dPinPosY[1]; // PCB좌표
		double dRefAlignX1 = pDoc->m_mgrReelmap.m_Master[0].m_stAlignMk.X1 + pView->m_pMotion->m_dPinPosX[1]; // PCB좌표
		double dRefAlignY1 = pDoc->m_mgrReelmap.m_Master[0].m_stAlignMk.Y1 + pView->m_pMotion->m_dPinPosY[1]; // PCB좌표
...
BOOL CDlgMenu02::Do4PtAlign0(int nPos, BOOL bDraw)
{
	...
	else if (nPos == 3)
	{
		...
		// Cam의 원점 기준의 Marking 이미지 좌표.
		double dRefAlignX0 = pDoc->m_mgrReelmap.m_Master[0].m_stAlignMk2.X0 + pView->m_pMotion->m_dPinPosX[0]; // PCB좌표
		double dRefAlignY0 = pDoc->m_mgrReelmap.m_Master[0].m_stAlignMk2.Y0 + pView->m_pMotion->m_dPinPosY[0]; // PCB좌표
		double dRefAlignX1 = pDoc->m_mgrReelmap.m_Master[0].m_stAlignMk2.X1 + pView->m_pMotion->m_dPinPosX[0]; // PCB좌표
		double dRefAlignY1 = pDoc->m_mgrReelmap.m_Master[0].m_stAlignMk2.Y1 + pView->m_pMotion->m_dPinPosY[0]; // PCB좌표
		double dRefAlignX2 = pDoc->m_mgrReelmap.m_Master[0].m_stAlignMk2.X2 + pView->m_pMotion->m_dPinPosX[0]; // PCB좌표
		double dRefAlignY2 = pDoc->m_mgrReelmap.m_Master[0].m_stAlignMk2.Y2 + pView->m_pMotion->m_dPinPosY[0]; // PCB좌표
		double dRefAlignX3 = pDoc->m_mgrReelmap.m_Master[0].m_stAlignMk2.X3 + pView->m_pMotion->m_dPinPosX[0]; // PCB좌표
		double dRefAlignY3 = pDoc->m_mgrReelmap.m_Master[0].m_stAlignMk2.Y3 + pView->m_pMotion->m_dPinPosY[0]; // PCB좌표
...
BOOL CDlgMenu02::Do4PtAlign1(int nPos, BOOL bDraw)
{
	...
	else if (nPos == 3)
	{
		...
		// Cam의 원점 기준의 Marking 이미지 좌표.
		double dRefAlignX0 = pDoc->m_mgrReelmap.m_Master[0].m_stAlignMk2.X0 + pView->m_pMotion->m_dPinPosX[1]; // PCB좌표
		double dRefAlignY0 = pDoc->m_mgrReelmap.m_Master[0].m_stAlignMk2.Y0 + pView->m_pMotion->m_dPinPosY[1]; // PCB좌표
		double dRefAlignX1 = pDoc->m_mgrReelmap.m_Master[0].m_stAlignMk2.X1 + pView->m_pMotion->m_dPinPosX[1]; // PCB좌표
		double dRefAlignY1 = pDoc->m_mgrReelmap.m_Master[0].m_stAlignMk2.Y1 + pView->m_pMotion->m_dPinPosY[1]; // PCB좌표
		double dRefAlignX2 = pDoc->m_mgrReelmap.m_Master[0].m_stAlignMk2.X2 + pView->m_pMotion->m_dPinPosX[1]; // PCB좌표
		double dRefAlignY2 = pDoc->m_mgrReelmap.m_Master[0].m_stAlignMk2.Y2 + pView->m_pMotion->m_dPinPosY[1]; // PCB좌표
		double dRefAlignX3 = pDoc->m_mgrReelmap.m_Master[0].m_stAlignMk2.X3 + pView->m_pMotion->m_dPinPosX[1]; // PCB좌표
		double dRefAlignY3 = pDoc->m_mgrReelmap.m_Master[0].m_stAlignMk2.Y3 + pView->m_pMotion->m_dPinPosY[1]; // PCB좌표
