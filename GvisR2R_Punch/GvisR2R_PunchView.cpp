...
//		{
//			if (m_mgrPunch->m_pMotion->IsEnable(MS_X0) && m_mgrPunch->m_pMotion->IsEnable(MS_Y0))				// 모션이 Enable상태이고
//			{
//				if (m_mgrPunch->m_pMotion->IsMotionDone(MS_X0) && m_mgrPunch->m_pMotion->IsMotionDone(MS_Y0))	// 모션 Done상태이면,
//				{
//					if (!IsInitPos0() && !IsPinPos0())									// 초기위치가 아니거나, 핀위치가 아닐때
//						m_mgrPunch->MoveInitPos0();													// 초기위치로 이동
//				}
//			}
//
...
//		MpeWrite(_T("ML45096"), (long)m_mgrProcedure->m_nTotMk[0]);	// 마킹부 (좌) 총 마킹수 
//	}
...
//		MpeWrite(_T("ML45098"), (long)m_mgrProcedure->m_nMkPcs[0]);	// 마킹부 (좌) 현재 마킹한 수
//	}
//
//	if (m_mgrProcedure->m_nPrevTotMk[1] != m_mgrProcedure->m_nTotMk[1])
//	{
//		m_mgrProcedure->m_nPrevTotMk[1] = m_mgrProcedure->m_nTotMk[1];
//		MpeWrite(_T("ML45100"), (long)m_mgrProcedure->m_nTotMk[1]);	// 마킹부 (우) 총 마킹수 
//	}
...
//		MpeWrite(_T("ML45102"), (long)m_mgrProcedure->m_nMkPcs[1]);	// 마킹부 (우) 현재 마킹한 수
//	}
//#endif
//}
